...
public class SearchableListDialogProfestion extends DialogFragment implements
    ...
    public SearchableListDialogProfestion() {

    }

    public static SearchableListDialogProfestion newInstance(List items) {
        SearchableListDialogProfestion multiSelectExpandableFragment = new
                SearchableListDialogProfestion();
