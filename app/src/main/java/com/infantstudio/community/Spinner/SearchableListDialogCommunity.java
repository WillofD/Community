...
public class SearchableListDialogCommunity extends DialogFragment implements
    ...
    public SearchableListDialogCommunity() {

    }

    public static SearchableListDialogCommunity newInstance(List items) {
        SearchableListDialogCommunity multiSelectExpandableFragment = new
                SearchableListDialogCommunity();
