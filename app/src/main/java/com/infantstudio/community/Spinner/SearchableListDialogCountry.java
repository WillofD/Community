...
public class SearchableListDialogCountry extends DialogFragment implements
    ...
    public SearchableListDialogCountry() {

    }

    public static SearchableListDialogCountry newInstance(List items) {
        SearchableListDialogCountry multiSelectExpandableFragment = new
                SearchableListDialogCountry();
