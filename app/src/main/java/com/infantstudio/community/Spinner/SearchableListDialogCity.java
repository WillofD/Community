...
public class SearchableListDialogCity extends DialogFragment implements
    ...
    private SearchableListDialogCity.SearchableItem _searchableItem;
    ...
    public SearchableListDialogCity() {

    }

    public static SearchableListDialogCity newInstance(List items) {
        SearchableListDialogCity multiSelectExpandableFragment = new
                SearchableListDialogCity();
