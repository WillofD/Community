 ...
 */
public class FragmentStateListFeedItem {

    private String news_title,news_details,news_image;


    public FragmentStateListFeedItem(){


    }
    public FragmentStateListFeedItem(String news_title, String news_details, String news_image) {
