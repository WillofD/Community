 ...
 */
public class ChurchNewsFeedImageView extends ImageView {
    ...
    public ChurchNewsFeedImageView(Context context) {
        this(context, null);
    }

    public ChurchNewsFeedImageView(Context context, AttributeSet attrs) {
